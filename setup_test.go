...
nameserver 10.10.255.253`), 0600); err != nil {
	...
	tests := []struct {
		...
		{`aggregate . ` + resolv, false, "", []string{"10.10.255.252:53", "10.10.255.253:53"}},
	}
