## How to build Coredns image with aggregate plugin?
At this moment exist two ways how to build Coredns image with aggregate plugin.
...
$ cd coredns
$ echo aggregate:github.com/lllamnyp/aggregate >> plugin.cfg
$ make
```
...
You can also use files prepared for lllamnyp. For this you need to run:
```bash
